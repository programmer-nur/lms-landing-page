...
const Hero = () => {
  return (
    <div className="relative z-10 md:h-[cal(100vh-64px)]">
      ...
      />
      <div className="mx-auto py-8 max-w-7xl flex flex-col  items-center justify-between gap-8 md:gap-14 lg:flex-row px-4 sm:px-6 lg:px-8 ">
        <div className="flex text-softBlack flex-col items-center justify-center lg:w-1/2 lg:items-start">
          ...
          <h2 className="text-center text-4xl font-semibold text-softBlack md:text-6xl lg:text-start">
            The Best <span className="text-main">Platform</span> for Enhancing
            Skills
          </h2>
          ...
          <Link
            href="/portfolio"
            className="flex items-center justify-start rounded-lg bg-main px-4 py-2 text-base font-medium text-softWhite shadow hover:bg-gray-700 hover:text-white hover:transition md:text-lg"
          >
            GET STARTED
          </Link>
        </div>
